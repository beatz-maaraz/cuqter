        ...
        if (mounted && _videoController == controller) {
          ...
          controller.addListener(() {
            ...
            if (controller.value.isInitialized) {
              if (controller.value.isPlaying && !_animationController.isAnimating) {
                _animationController.forward();
              } else if (!controller.value.isPlaying && _animationController.isAnimating) {
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            return GestureDetector(
              ...
              child: Stack(
                ...
                children: [
                  if (status.mediaType == 'video')
                    SizedBox.expand(
                      child: index == _currentIndex && _videoController != null && _videoController!.value.isInitialized
                          ? FittedBox(
                              fit: BoxFit.contain,
                              child: SizedBox(
                  ...
                  if (status.caption.isNotEmpty && (status.mediaType == 'image' || status.mediaType == 'video'))
                    Positioned(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      final doc = await FirebaseFirestore.instance.collection('users').doc(_currentGroup[_currentIndex].uid).get();
                      String name = _currentGroup[_currentIndex].username;
                      String bio = '';
                      String profilePic = _currentGroup[_currentIndex].profilePic;
                      if (doc.exists) {
                        final data = doc.data();
                        if (data != null) {
                          name = data['name'] ?? _currentGroup[_currentIndex].username;
                          bio = data['bio'] ?? '';
                          profilePic = data['profilepic'] ?? _currentGroup[_currentIndex].profilePic;
                        }
                      }
                      if (mounted) {
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              _formatTimeAgo(_currentGroup[_currentIndex].createdAt),
            ...
            if (_currentUserId != null && _currentGroup[_currentIndex].uid == _currentUserId)
              Positioned(
                bottom: 0,
                left: 0,
                right: 0,
                              ...
                              return SafeArea(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (_currentGroup[_currentIndex].viewers.isEmpty)
                                      const Padding(
                                        padding: EdgeInsets.all(16.0),
                                    ...
                                    ...(() {
                                      ...
                                      for (var v in _currentGroup[_currentIndex].viewers) {
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () => _sendReply(_currentGroup[_currentIndex]),
                        ),
                      ],
                    ),
                  ),
            ...
            if (kIsWeb || defaultTargetPlatform == TargetPlatform.windows) ...[
              if (_currentIndex > 0)
                Positioned(
                  ...
                  child: Center(
                    child: IconButton(
                      icon: const huge.HugeIcon(icon: huge.HugeIcons.strokeRoundedArrowLeft01, color: Colors.white, size: 28),
              ...
              Positioned(
                ...
                child: Center(
                  child: IconButton(
                    icon: const huge.HugeIcon(icon: huge.HugeIcons.strokeRoundedArrowRight01, color: Colors.white, size: 28),
          ...
          return Container(
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                return Container(
                  width: constraints.maxWidth * _animationController.value.clamp(0.0, 1.0),
                  height: 3,
                  decoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.circular(1.5),
